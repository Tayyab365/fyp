...
const Products = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen space-y-6 p-3 sm:p-6">
      {/* Header */}
            ...
            <table className="w-full text-sm text-left border-collapse min-w-[700px]">
              <thead className="bg-gray-100 text-gray-700 uppercase text-xs font-semibold tracking-wider">
                <tr>
                  ...
                  <th className="py-3 px-4 sm:px-5">Stock</th>
              ...
              <tbody className="text-gray-600">
                {products.map((product, index) => (
                  ...
                  >
                    <td className="py-3 px-4 sm:px-5 font-medium text-gray-800">
                      {index + 1}
                    </td>
                    ...
                    <td className="py-3 px-4 sm:px-5">{product.name}</td>
                    <td className="py-3 px-4 sm:px-5 capitalize">
                      {product.category}
                    </td>
                    <td className="py-3 px-4 sm:px-5 font-semibold text-gray-700">
                      ${product.price}
                    </td>
                    <td className="py-3 px-4 sm:px-5">
                      {product.stock ?? (
                    ...
                    {/* Buttons */}
                    <td className="py-3 px-4 sm:px-5 flex justify-center gap-3">
                      <button
